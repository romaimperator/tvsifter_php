...
<?php echo $this->element('users/upcoming', array('cache' => array('key' => $user_id, 'time' => '+10 minutes'))); ?>

<?php //echo $this->element('users/shows', array('cache' => FALSE));//array('key' => $user_id, 'time' => '+1 second'))); ?>

<?php echo $this->element('users/friend_feed', array('cache' => array('key' => $user_id, 'time' => '+10 minutes'))); ?>
